...
base1.1 <- read.csv('https://github.com/jorgeo80/IntroR_Webinar/tree/master/Dia_I/Bases/cars.csv', header = TRUE)
...
tv <- read.table('https://github.com/jorgeo80/IntroR_Webinar/tree/master/Dia_I/Bases/tv.txt', header = TRUE)
